...
def reconhece():
    ...
    plates = cv2.imread(
        'C:/Users/Daniel/Documents/Projetos/Reconhecimento-Placa/output/roi-ocr.png')
    if plates is None:
        return
    plates_filter_applied = apply_filter(plates)
    plates_numbers = (scan_plate(plates_filter_applied))
    if plates_numbers in not_authorized_plate:
        playsound(
            "C:/Users/Daniel/Documents/Projetos/Reconhecimento-Placa/SIRENE.mp3")
    else:
        print("AUTHORIZED")
